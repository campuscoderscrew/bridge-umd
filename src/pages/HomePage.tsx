    ...
    <div className="font-sans text-white" style={{ backgroundColor: "#1a2a3a" }}>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-10 items-start">
          ...
          <div>
            ...
            <p className="text-sm mb-3" style={{ color: "#ffffff" }}>
              BridgeUMD is the UMD chapter of BridgeUSA which is not about changing minds or creating centrists, but
              encouraging students to engage differing beliefs, experiences and perspectives. What unites us is not
              agreement on policies, but a shared mindset. Every discussion is run by moderators and these norms of
              discussion to ensure a productive dialogue.
            </p>
        ...
        <div className="max-w-5xl mx-auto pb-16 px-4 sm:px-10">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 mb-8">
            <button
              ...
              style={{
                backgroundColor: eventTab === "upcoming" ? "#2E4052" : "transparent",
                color: eventTab === "upcoming" ? "#ffffff" : "#2E4052",
            ...
            <button
              ...
              className="px-6 py-2 rounded-full font-semibold text-sm"
              style={{
                backgroundColor: eventTab === "past" ? "#2E4052" : "transparent",
                color: eventTab === "past" ? "#ffffff" : "#2E4052",
                border: "2px solid #2E4052",
                cursor: "pointer",
              }}
            >
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-4">
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/bridge-umd-96a269273"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#ffffff" }}
          >
